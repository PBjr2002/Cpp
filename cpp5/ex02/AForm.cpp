...
{
	out<<form.getName()<<", AForm signed : "<<form.getSigned()<<std::endl;
	out<<form.getName()<<", AForm grade to sign : "<<form.getGradeToSign()<<std::endl;
	out<<form.getName()<<", AForm grade to execute : "<<form.getGradeToExecute();
	return (out);
}
...
{
	return ("AForm is not signed therefore cannot be executed");
}
