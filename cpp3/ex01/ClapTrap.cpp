...
ClapTrap::ClapTrap() : _hitPts(Clap_HP), _energyPts(Clap_ENERGY), _atackDmg(Clap_DAMAGE)
{
...
ClapTrap::ClapTrap(std::string str) : _name(str), _hitPts(Clap_HP), _energyPts(Clap_ENERGY), _atackDmg(Clap_DAMAGE)
{
...
void	ClapTrap::statDump(void)
{
	std::cout<<"Name : "<<_name<<std::endl;
	std::cout<<"HP : "<<_hitPts<<std::endl;
	std::cout<<"Energy : "<<_energyPts<<std::endl;
	std::cout<<"Damage : "<<_atackDmg<<std::endl;
}
